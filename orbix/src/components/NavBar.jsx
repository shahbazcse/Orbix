...
export default function NavBar() {
  return (
    <div className="flex sticky top-0 z-10 justify-between items-center font-bold font-mont pl-8 pr-12 text-white drop-shadow-2xl opacity-[0.85] bg-black border-b-[1px] border-[#eef1f52c] py-4">
